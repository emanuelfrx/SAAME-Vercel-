...
const MetricExplanationPanel: React.FC<MetricExplanationPanelProps> = ({ char, font }) => {
    ...
    return (
        <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 rounded-xl mt-4 text-left">
            <div className="flex items-center gap-5 justify-center mb-3">
                <div className="flex flex-col items-center">
                    <div className="bg-zinc-200 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 text-[10px] font-black px-1.5 py-0.5 rounded uppercase tracking-[0.2em] mb-1">Standard</div>
                    <span className="text-xl font-black dark:text-white text-zinc-950 leading-none">{char}</span>
                </div>
            </div>
            <p className="text-xs dark:text-zinc-400 text-zinc-700 font-medium italic border-t border-zinc-200 dark:border-zinc-800 pt-2 leading-relaxed text-center">
                {getExplanation()}
            </p>
        </div>
    );
...
const TunerBlock: React.FC<TunerBlockProps> = React.memo(({ char, title, testWords, settings, onUpdate, font, fontFamily, onAuto, symmetrical = false }) => {
  ...
  const handleWordsChange = (newWords: string[]) => {
    ...
    return (
        <div className="dark:bg-zinc-900/40 bg-zinc-100/60 p-3 md:p-5 rounded-2xl border-l-4 border-black dark:border-white border dark:border-zinc-800 border-zinc-200 shadow-sm transition-transform hover:translate-x-1">                
                    ...
                    <div className="h-0.5 w-8 bg-zinc-400 dark:bg-zinc-600 mt-1 rounded-full" />
                         ...
                         {onAuto && (
                             <button 
                                ...
                                className="text-xs font-bold uppercase tracking-widest bg-zinc-200 hover:bg-zinc-300 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-900 dark:text-zinc-100 px-3 py-1.5 rounded-lg flex items-center gap-1.5 border border-zinc-300 dark:border-zinc-700 transition-all focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
                        ...
                        {symmetrical ? (
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-1">
                                    <label className="text-sm dark:text-white text-zinc-950 font-bold">
                                        Side Bearings (x/2)
                                ...
                                />
                                <p className="text-[11px] dark:text-zinc-400 text-zinc-600 mt-2 italic">Ajuste baseado na contraforma (x): SB ideal = x/2 em ambos os lados.</p>
                            </div>
                        ) : (
                            <>
                                {/* LSB Control */}
                                ...
                                <div>
                                    ...
                                    />
                                    <p className="text-[11px] dark:text-zinc-400 text-zinc-600 mt-2 italic">À direita, o espaço é ligeiramente reduzido para compensar a curvatura do arco.</p>
                                </div>
                            </>
                        )}
                    </div>
        ...
        <div className="flex items-center gap-4">
            ...
            <div>
                ...
                <div className="flex items-center gap-2">
                    <p className="text-xs text-zinc-600 dark:text-zinc-400 uppercase font-black tracking-widest pb-[1px]">Walter Tracy (1914–1995)</p>
        ...
        <div className="mt-12 border-t dark:border-zinc-800 border-zinc-200 pt-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-xs dark:text-zinc-400 text-zinc-600 uppercase tracking-widest font-bold mt-1">Sobrescreva as regras para glifos específicos (H3/H5)</p>
                </div>
            </div>
            ...
            <div className="dark:bg-zinc-900/40 bg-zinc-100/60 p-6 rounded-2xl border dark:border-zinc-800 border-zinc-200 shadow-sm">
                 ...
                 <div className="flex flex-col md:flex-row md:items-center gap-6 mb-8 dark:bg-zinc-950/60 bg-white p-6 rounded-2xl border dark:border-zinc-800 border-zinc-200">
                     <div className="flex-1">
                         <div className="flex items-center justify-between mb-2">
                             <label className="text-xs dark:text-zinc-400 text-zinc-600 font-black uppercase tracking-widest block">Seletor de Glifo de Referência</label>
                             <button
                     ...
                     <div className="text-base dark:text-zinc-400 text-zinc-600 flex flex-col justify-end">
                         <div className="flex items-center gap-3 dark:bg-zinc-900 bg-zinc-100 p-3 rounded-xl border dark:border-zinc-800 border-zinc-200">
                             ...
                             {hasOverride ? (
                                 ...
                                 <span className="text-zinc-700 dark:text-zinc-300 font-black px-3 py-1 bg-zinc-100 dark:bg-zinc-900 rounded-lg border border-zinc-300 dark:border-zinc-700 text-xs uppercase tracking-widest">Por Regra</span>
                             )}
                         </div>
                         ...
                         {hasOverride && (
                             <button 
                               ...
                               className="text-xs text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white font-black uppercase tracking-widest flex items-center gap-1.5 mt-3 justify-end transition-colors focus:outline-none focus:underline focus:ring-1 focus:ring-black dark:focus:ring-white rounded"
                 ...
                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                    <div className="space-y-6 order-2 lg:order-1">
                        ...
                        {/* Text Preview (Live) editable */}
                        <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 shadow-sm rounded-2xl p-4 md:p-5 mt-2 flex flex-col justify-center min-h-[110px] w-full max-w-[100vw] sm:max-w-full shrink-0 max-h-[300px] overflow-y-auto custom-scrollbar">
                            {isOverrideEditing ? (
                                <div className="flex flex-col items-center justify-center w-full py-2" onClick={(e) => e.stopPropagation()}>
                                    <input 
                                        type="text"
